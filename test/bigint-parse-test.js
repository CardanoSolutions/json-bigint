...
describe('Testing native BigInt support: parse', function () {
  ...
  it('Should not attempt to parse decimal numbers as BigInt.', function (done) {
    var JSONbig = require('../index')({ useNativeBigInt: true });
    var result = JSONbig.parse('5.469120721016755e9');
    expect(result).to.equal(5.469120721016755e9);
    done();
  });
});
